...
public static class TestFrameworkOptionsReadWriteExtensions
{
	...
	/// <summary>
	/// Gets options which determine the amount of test parallelization to allow by default.
	/// </summary>
	...
	/// <summary>
	/// Gets options which determine the amount of test parallelization to allow by default. If not
