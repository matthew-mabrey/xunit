...
public static class TestFrameworkOptionsReadExtensions
{
	...
	/// <summary>
	/// Gets options which determine the amount of parallelization to allow for tests by default.
	/// </summary>
	/// <remarks>
	/// Overridden by <see cref="CollectionDefinitionAttribute.ParallelismOptions"/> within collections, unless
	/// set to <see cref="ParallelismOptions.None"/>. In which case, all tests will be run serially.
	/// </remarks>
