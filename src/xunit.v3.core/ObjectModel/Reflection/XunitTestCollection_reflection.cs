...
/// <summary>
/// Default implementation of <see cref="IXunitTestCollection"/> for xUnit.net v3 tests.
/// </summary>
/// <remarks>
...
public class XunitTestCollection : IXunitTestCollection, IXunitSerializable
{
	...
	public XunitTestCollection()
	{
		...
		testCaseOrderer = new(() => RegisteredEngineConfig.GetCollectionTestCaseOrderer(CollectionDefinition));
		testClassOrderer = new(() => RegisteredEngineConfig.GetCollectionTestClassOrderer(CollectionDefinition));
		testMethodOrderer = new(() => RegisteredEngineConfig.GetCollectionTestMethodOrderer(CollectionDefinition));
	...
	/// <param name="disableParallelization">A flag to indicate whether this test collection opts out of parallelization with other collections</param>
	/// <param name="enableTestCaseParallelization">A flag to indicate whether tests in this collection should run in parallel</param>
...
#pragma warning restore CS0618
	...
	/// <inheritdoc/>
	public bool EnableTestCaseParallelization { get; private set; }
	...
	public void Deserialize(IXunitSerializationInfo info)
	{
		...
		EnableTestCaseParallelization = Guard.NotNull("Could not retrieve EnableTestCaseParallelization from serialization", info.GetValue<bool?>("etcp"));
	...
	public void Serialize(IXunitSerializationInfo info)
	{
		...
		info.AddValue("etcp", EnableTestCaseParallelization);
