...
#pragma warning disable CS0618
			FailTestMethod(ctxt, testMethod, testCases, [], exception);
#pragma warning restore CS0618

	/// <summary>
	/// Please override <see cref="FailTestMethod(TContext, TTestMethod?, IReadOnlyCollection{TTestCase}, Exception)"/>.
	/// This overload will always be called with empty <paramref name="constructorArguments"/>, and will be removed in
	/// the next major version.
	/// </summary>
	[Obsolete("Please override FailTestMethod without constructorArguments. This overload will always be called with empty constructorArguments, and will be removed in the next major version.")]
	...
	/// from derived implementations of this method, <see cref="RunTestMethods"/>, or
	/// <see cref="RunTestMethod(TContext, TTestMethod?, IReadOnlyCollection{TTestCase})"/>)
	...
	/// test cases. This method is no longer called and will be removed in the next major version.
	/// </summary>
	...
	/// </remarks>
#endif
	[Obsolete("Please override the overload without constructorArguments. This overload will be removed in the next major version.", error: true)]
	[EditorBrowsable(EditorBrowsableState.Never)]
	protected ValueTask<RunSummary> RunTestMethod(
		TContext ctxt,
		TTestMethod? testMethod,
		IReadOnlyCollection<TTestCase> testCases,
		object?[] constructorArguments) =>
