...
public abstract class CoreTestCollectionRunnerContext<TTestCollection, TTestClass, TTestCase>(
	...
	SemaphoreSlim? parallelizationSemaphore = null) :
		TestCollectionRunnerContext<TTestCollection, TTestCase>(testCollection, testCases, explicitOption, messageBus, aggregator, cancellationTokenSource, parallelizationSemaphore)
