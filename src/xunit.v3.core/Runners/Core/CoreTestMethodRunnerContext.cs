...
public abstract class CoreTestMethodRunnerContext<TTestMethod, TTestCase>(
	...
	SemaphoreSlim? parallelizationSemaphore = null) :
		TestMethodRunnerContext<TTestMethod, TTestCase>(testMethod, testCases, explicitOption, messageBus, aggregator, cancellationTokenSource, parallelizationSemaphore)
